...
Windows 11, Windows Terminal, Oh-My-Posh, Cursor IDE, Neovim, ZLocation, Commandbox, Powershell, JetBrains DataGrid.

Optionally, NixOS WSL

1. Install chocolatey and scoop
	- `irm get.scoop.sh | iex`
2. Install Node Version Manager
	- https://github.com/coreybutler/nvm-windows/releases
	- Will be replaced by Runtime eventually: https://github.com/coreybutler/nvm-windows/wiki/Runtime
3. scoop install git
4. scoop bucket add extras
5. scoop install neovim
...
8. scoop install oh-my-posh
9. oh-my-posh font install meslo
10. Install zLocation (equivelant to zoxide)
...
12. git clone this repo into ~\.dotfiles
13. Install Powershell Latest (currently 7)
	- `winget search Microsoft.PowerShell`
	- `winget install --id Microsoft.PowerShell.Preview --source winget`
14. Launch Windows Terminal
15. Add Powershell 7 profile and make it the default profile
16. Make the defaults profile "Run this profile as Administrator"
17. Install/Enable WSL 2 
18. Download installer from https://github.com/nix-community/NixOS-WSL
19. `wsl --import <name-your-os> .\NixOS\ nixos-wsl.tar.gz --version 2`
20. Use powershell alias `nup` to enter distro `wsl -d <name-your-os>`
21. Follow instructions from https://github.com/webmandman/nixos-wsl-starter
    - Original repo comes with lunarvim, remove from home.nix config. 
22. Install Commandbox
...
23. keybindings for Windows Terminal. Windows Terminal Json path??? Syslink to a .dotfile???
